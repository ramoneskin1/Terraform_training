...
resource "aws_main_route_table_association" "levelup-public-1-a" {
  vpc_id         = aws_subnet.levelupvpc-public-1.id
  route_table_id = aws_route_table.levelup-public.id
}

  resource "aws_main_route_table_association" "levelup-public-2-a" {
  vpc_id         = aws_subnet.levelupvpc-public-2.id
  route_table_id = aws_route_table.levelup-public.id
}

  resource "aws_main_route_table_association" "levelup-public-3-a" {
  vpc_id         = aws_subnet.levelupvpc-public-3.id
  route_table_id = aws_route_table.levelup-public.id
}
